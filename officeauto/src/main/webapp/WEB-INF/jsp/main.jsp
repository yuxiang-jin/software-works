        ...
        function addPanel(id, url, name) {
            ...
            if (exist) {
                ...
                $('#tt').tabs('add', {
                    id: id,
                    title: name,
                    content: '<div style="width:100%;height:100%;"><iframe class="page-iframe" src="${ctx}' + url + '" frameborder="no" border="no" heignt="100%" width="100%" scrolling="auto"></iframe></div>',
                    closable: true
                });
            }
        }
    ...
    <div class="container">
        <div id="pf-hd">
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img style="width: 40px;height: 40px;" src="${ctx}/images/main/yuxiang.jpg" alt="">
                </div>
                <h4 class="pf-user-name ellipsis">${sessionScope.user_session.userName}</h4>
        ...
        <div id="pf-bd">
            <div id="pf-sider">
                <h2 class="pf-model-name">
                    <span class="iconfont">&#xe64a;</span>
                    <span class="pf-name">智能办公系统</span>
                    ...
                    <c:forEach items="${userPopedomModules}" var="userModule">
                        <li>
                            <a href="javascript:;">
                                ...
                                <span class="sider-nav-title">${userModule.firstModule.moduleName}</span>
                                <i class="iconfont">&#xe642;</i>
                            </a>
                            <ul class="sider-nav-s">
                                <c:forEach items="${userModule.secondModules}" var="secondModule">
                                    <li><a href="javascript:addPanel('${secondModule.moduleCode}','${secondModule.moduleUrl}','${secondModule.moduleName}')">${secondModule.moduleName}</a></li>
                                </c:forEach>
                            </ul>
                        </li>
                    </c:forEach>
            ...
            <div id="pf-page">
                <div class="easyui-tabs" id="tt" style="width: 100%;height: 100%;">
                    <div title="当前用户" id="user" style="padding: 10px 5px 5px 10px;">
                        <iframe class="page-iframe" class="${ctx}/oa/home" height="100%" width="100%" scrolling="auto"></iframe>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="pf-ft">
            ...
            <div class="copyright-name">
                <span>Copyright&nbsp;©&nbsp;2022&nbsp;-&nbsp;2023&nbsp;玉祥软件&nbsp;版权所有</span>
                <i class="iconfont">&#xe6ff;</i>
            </div>
        </div>
    </div>
