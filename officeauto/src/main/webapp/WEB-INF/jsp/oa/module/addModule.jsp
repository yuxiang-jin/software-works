...
<body style="background: #F5FAFA;">
    <div style="text-align: center;">
        <form id="addModuleForm" action="${ctx}/oa/module/addModule" method="post" style="padding: 10px;">
            ...
            <table class="table-condensed" width="90%" height="100%">
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" id="name" name="name" value="${module.moduleName}" class="form-control" placeholder="请输入您的模块名"/></td>
                    </tr>
                    <tr>
