...
<head>
    ...
    <script type="text/javascript">
        ...
        function refreshTree() {
            ...
            d.add(-2, -1, '系统模块树');
            d.add(0, -2, '全部', "javascript:refreshSonModules('${ctx}/oa/module/getModulesByParent')");
...
<body class="easyui-layout" style="width: 100%;height: 100%;">
    <div id="tree" data-options="region:'west'" title="菜单模块树" style="width:20%;padding: 10px;">
        <!-- 展示所有的模块树 -->
        <iframe src="${ctx}/oa/module/loadAllModuleTrees" frameborder="0" id="allModules" width="100%" height="100%"></iframe>
    </div>
    <div data-options="region:'center'" title="模块菜单">
        <!-- 展示当前模块下的子模块 -->
        <iframe src="${ctx}/oa/module/getModulesByParent" frameborder="0" id="sonModules" width="100%" height="100%"></iframe>
    </div>
</body>
</html>
