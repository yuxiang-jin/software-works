...
<head>
    ...
    <meta http-equiv="description" content="This is operas page"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#back").click(function () {
                parent.window.location = "${ctx}/oa/role/selectRole"
            });
            ...
            $("#bindPopedom").click(function () {
                ...
                window.location = "${ctx}/oa/popedom/bindPopedom?codes=" + params.get() + "$parentCode=${parentCode}&id=${role.roleId}&name=${role.roleName}&moduleName=${moduleName}";
            })
        });
    </script>
</head>
        ...
        <div class="panel panel-primary">
            ...
            <div style="padding: 5px;">
                ...
                <button type="button" disabled="disabled" class="btn btn-default">
                    <span class="glyphicon glyphicon-user" aria-hidden="true"></span><span style="font-style:italic;">当前角色：${role.roleName}</span>
                </button>
            </div>

            <div class="panel-heading" style="background-color: #11a9e2;">
                <h3 class="panel-title">
                    <label style="color: white;font-size:15px;"><span class="glyphicon glyphicon-yen"></span>&nbsp;${moduleName.replace('-','')}</label>
                </h3>
            </div>
