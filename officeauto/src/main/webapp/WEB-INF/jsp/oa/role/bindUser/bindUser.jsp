...
<head>
    ...
    <meta http-equiv="description" content="This is bind user page"/>
        ...
        $(function () {
            ...
            $("#bindUser").on("click", function () {
                ...
                if (checkedBoxs.length > 0) {
                    ...
                    //alert(maps.get());
                    window.location = "${ctx}/oa/role/bindUser?ids=" + maps.get() + "&pageIndex=${pageModel.pageIndex}&id=${role.roleId}";
                } else {
