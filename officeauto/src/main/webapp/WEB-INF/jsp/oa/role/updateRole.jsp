...
<body style="background: #F5FAFA;">
    <div style="text-align: center;">
        <form id="updateRoleForm" action="${ctx}/oa/role/updateRole" method="post" style="padding: 10px;">
            <input type="hidden" value="${role.roleId}" name="id"/>
