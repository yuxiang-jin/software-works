...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if("${user.userQuestion}") $("#question").val("${user.userQuestion}");
            if("${user.userSex}") $("#sex").val("${user.userSex}");
...
<body style="background: #F5FAFA;">
    <div style="text-align: center;">
        <form id="updateUserForm" action="${ctx}/oa/user/updateUser" method="post">
            <%--当前用户的userId--%>
            ...
            <table class="table-condensed">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input id="name" name="name" type="text" value="${user.userName}" class="form-control" placeholder="请输入用户姓名"/>
                        </td>
                    </tr>
                    <tr>
                        <td><label>密码：</label></td>
                        <td>
                            <input id="password" name="password" type="password" value="${user.userPassword}" class="form-control" placeholder="请输入您的密码"/>
                        </td>
                        <td><label>确认密码：</label></td>
                        <td>
                            <input id="repwd" name="repwd" type="password" value="${user.userPassword}" class="form-control" placeholder="请输入您的确认密码"/>
                        </td>
                    </tr>
                    <tr>
                        <td><label>性别：</label></td>
                        <td>
                            <select id="sex" name="sex" class="btn btn-default">
            ...
            <div align="center" style="margin-top: 20px;">
                <a id="btn_submit" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span>&nbsp;修改</a>
